namespace Erbsenzaehler.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            // we need to manually set the ON DELETE SET NULL
            Sql("ALTER TABLE dbo.Lines ADD CONSTRAINT [FK_dbo.Lines_dbo.Categories_CategoryId] FOREIGN KEY (CategoryId) REFERENCES dbo.Categories(Id) ON UPDATE NO ACTION ON DELETE SET NULL");
        }
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Lines", "CategoryId", "dbo.Categories");
            DropForeignKey("dbo.Lines", "AccountId", "dbo.Accounts");
            DropForeignKey("dbo.Categories", "ClientId", "dbo.Clients");
            ...
            DropIndex("dbo.Lines", new[] { "CategoryId" });
